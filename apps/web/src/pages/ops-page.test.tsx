...
describe('OpsPage', () => {
  it('renders the ops shell with navigation and active panel when enabled', async () => {
    ...
    expect(document.title).toBe('Ops Console – Insight AI [Phase 1] — Simulator')
    ...
    expect(document.title).toBe('Ops Console – Insight AI [Phase 1] — Health')
  ...
  it('restores the active ops section from the URL', async () => {
    ...
    expect(document.title).toBe('Ops Console – Insight AI [Phase 1] — Signals Browser')
  })
